...
#SBATCH --mem=0
#SBATCH --output=/work/bd1179/b309216/icon/ICON-2.6.4/icon-tuning-analysis/Postprocessing_PaperExample/logs/LOG.err.run_analysis_R2B5_1979-1980_nrun_0-PaperExample.%j.o 
#SBATCH --error=/work/bd1179/b309216/icon/ICON-2.6.4/icon-tuning-analysis/Postprocessing_PaperExample/logs/LOG.err.run_analysis_R2B5_1979-1980_nrun_0-PaperExample.%j.err
#SBATCH --exclusive
