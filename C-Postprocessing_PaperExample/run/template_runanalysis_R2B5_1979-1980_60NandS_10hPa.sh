...
#SBATCH --job-name=run_analysis_R2B5_1979-1980_JOBNAME_ANA
#SBATCH --partition=compute
#SBATCH --nodes=1
#SBATCH --threads-per-core=2
#SBATCH --mem=0
#SBATCH --output=/work/bd1179/b309216/icon/ICON-2.6.4/icon-tuning-analysis/Postprocessing_PaperExample/logs/LOG.err.run_analysis_R2B5_1979-1980_JOBNAME_ANA.%j.o 
#SBATCH --error=/work/bd1179/b309216/icon/ICON-2.6.4/icon-tuning-analysis/Postprocessing_PaperExample/logs/LOG.err.run_analysis_R2B5_1979-1980_JOBNAME_ANA.%j.err
#SBATCH --exclusive
